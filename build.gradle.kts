...
//    ----- TestCode
    testImplementation("io.kotest:kotest-runner-junit5:5.5.5") // 추가 !!
    testImplementation("io.kotest:kotest-assertions-core:5.5.5") // 추가 !!
    testImplementation("io.kotest.extensions:kotest-extensions-spring:1.1.3") // 추가 !!
    testImplementation("io.mockk:mockk:1.13.8") // 추가 !!
